...
- This example is a fictional, illustrative scenario — not the actual
  ...
  [Chem-Eng Projects hub](https://second-hand-tigers.github.io/chem-eng-projects/)
...
- Actual industry design discussions of this kind are typically closely
  ...
  milestone of a project. For a successful project, stakeholder engagement
  and knowledge capture are just as critical as the technical work.
...
one milestone's tasks, open the [Backlog](https://github.com/orgs/second-hand-tigers/projects/1/views/1)
or [Board](https://github.com/orgs/second-hand-tigers/projects/1/views/2) view and filter by milestone manually.
...
- **[Issues & Projects](https://github.com/second-hand-tigers/chem-eng-projects-MogasDebenz/issues)** — Where the work happens. Each milestone above links
...
- **[Wiki](https://github.com/second-hand-tigers/chem-eng-projects-MogasDebenz/wiki)** — Reference material and job aids: how-to guides, the model
...
- **GitHub Pages** — You're on it now: a polished, browsable front door to
  the project for anyone who doesn't need to dig into Issues or the Wiki
  directly.

**Where to start:** if you're picking up this project for the first time,
read the [Wiki home page](https://github.com/second-hand-tigers/chem-eng-projects-MogasDebenz/wiki), then work through the milestones above in order.
